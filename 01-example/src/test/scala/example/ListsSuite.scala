...
class ListsSuite extends munit.FunSuite:
  ...
  test("sum of a list of zeroes") {
    assertEquals(sum(List.fill(10)(0)), 0)
  }

  test("sum of a list of negative numbers") {
    assertEquals(sum(List(-1,-2,-3,-9)), -15)
  }
  ...
  test("sum of a list of repeated numbers") {
    assertEquals(sum(List(1,2,1,1,1,1,3,3,3,2,2,2,2)), 24)
  }
  ...
  test("max of a list of zeroes") {
    assertEquals(max(List.fill(10)(0)), 0)
  }
  ...
  test("max of a list of repeated numbers") {
    assertEquals(max(List(1,2,1,1,1,1,3,3,3,2,2,2,2)), 3)
  }
